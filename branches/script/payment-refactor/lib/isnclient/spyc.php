...
class Spyc {
  ...
  */
  ...
  /**
     ...
     * @param int $wordwrap Pass in 0 for no wordwrap, false for default (40)
     */
  function dump($array,$indent = false,$wordwrap = false, $ignore_private = false) {
    // Dumps to some very clean YAML.  We'll have to add some more features
    // and options soon.  And better support for folding.

    $this->_ignore_private = $ignore_private;
  ...
  function _yamlize($key,$value,$indent) {
    if ($this->_ignore_private) 
      if ($key[0] == '_') return ''; // removes private variables
